...
function Category({ category }) {
  return (
    <div className="rounded-xl bg-white w-[90%] mx-auto h-100 flex flex-col items-center justify-center font-sansBold relative overflow-hidden shadow-md transition-all duration-300 hover:shadow-xl hover:-translate-y-2 hover:scale-105">
      <img
